...
public class GameTemplate : ModuleRules
{
	public GameTemplate(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// Enable once UMG-based HUD/menu widgets land (Moon/Roadmaps/ui_ux.md):
		// PublicDependencyModuleNames.AddRange(new string[] { "UMG", "Slate", "SlateCore" });

		// Enable once MetaSounds work lands (Moon/Roadmaps/animation_audio.md §3):
		// PublicDependencyModuleNames.AddRange(new string[] { "MetasoundEngine", "AudioMixer", "SignalProcessing" });

		// Enable once replication/networking work lands (Moon/Roadmaps/networking.md):
