...
- Relevant existing design discussion: [link to `Docs/Docs/Moon/Roadmaps/*.md` section, or "none — this is new"].

Task:
1. Check `Docs/Docs/Moon/ROADMAP.md` and the relevant `Docs/Docs/Moon/Roadmaps/*.md` file for existing design options before proposing an approach.
...
- If the feature isn't in the roadmap yet, add it to the relevant `Docs/Docs/Moon/Roadmaps/*.md` file as part of this change.
