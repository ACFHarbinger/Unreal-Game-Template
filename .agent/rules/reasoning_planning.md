...
1. Check existing design options (`Docs/Docs/Moon/Roadmaps/*.md`, `Docs/Adr/`) before proposing a new approach — don't re-derive a decision that's already been made and recorded.
...
5. Long-running or multi-session work gets tracked in `Docs/Docs/Moon/ROADMAP.md`, not only in an ephemeral chat/PR description — the roadmap is the durable record.
