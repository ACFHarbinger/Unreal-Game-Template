...
**Scope:** `Docs/`, `Docs/Moon/`, `.agent/`, root-level `README.md`.

## Enforced

1. **One source of truth per fact.** An item lives in exactly one of `Docs/Docs/Moon/ROADMAP.md` (in progress/planned) or `Docs/CHANGELOG.md` (done) at a time — never both, never neither once started.
