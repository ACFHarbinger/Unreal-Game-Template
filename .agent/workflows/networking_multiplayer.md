...
1. **Confirm the module exists and is actually needed.** Don't build out `Source/GameTemplate/Network/` speculatively ahead of a validated single-player/local core loop — see `Docs/Docs/Moon/Roadmaps/networking.md`.
